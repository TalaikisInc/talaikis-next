    ...
    <section className="text-gray-700 body-font relative">
      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-no-wrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe width="100%" height="100%" className="absolute inset-0" frameBorder="0" title="map" marginHeight="0" marginWidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=Vilnius&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" style={{ filter: 'grayscale(1) contrast(1.2) opacity(0.4)' }}></iframe>
          <div className="bg-white relative flex flex-wrap py-6">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="leading-relaxed">Vilnius, Lithuania or London, United Kingdom</p>
            </div>
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm">EMAIL</h2>
              <a className="text-indigo-500 leading-relaxed">info@talaikis.com</a>
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mt-4">PHONE</h2>
              <p className="leading-relaxed">+370 692 21303</p>
              <p className="leading-relaxed"><a href="https://wa.me/447460271365">+44 746 0271365</a></p>
            </div>
          </div>
        </div>
          ...
          { loading ? <Loader /> : (reqError ? <Alert text={reqError} /> :
            (res && res.status === 'sent' ? <Success text="Thank you for your message! I'll respond ASAP." /> : <>
              ...
              <form onSubmit={onSubmit}>
                ...
                <p><button className="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" disabled={loading}>Send</button></p>
                <FormError name="name" error={error} />
              </form>
              <p className="text-xs text-gray-500 mt-3">I am usually responding within 24 hours.</p>
            </>
            ))}
        </div>
      </div>
