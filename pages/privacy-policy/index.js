...
const PrivacyPolicy = () => (
  <Layout title="Privacy Policy" path="/privacy-policy" image="https://www.talaikis.com/static/images/wallet.jpg">
    <Container>
      <GeneralHero title="Privacy Policy" />
      <Text>This Policy applies as between you, the User of this Web Site, any Services or Software provided by Talaikis Ltd. and the Talaikis Ltd. the owner and provider of this Web Site, Services and Software. This Policy applies to our use of any and all Data collected by us in relation to your use of the Web Site and any Services or Software therein (further - &quot;Service(s)&quot;).</Text>

      <Title>Important information</Title>
      <Text>Our Products are not intended for children and we do not knowingly collect data relating to children.</Text>
      <Text>This Privacy Policy supplements the other policies (including our <a href="/terms-of-use">terms of use (Terms)</a>) and is not intended to override them. </Text>
      <Text>Talaikis Ltd. is the controller and responsible for your personal data (we, us or our).</Text>
      <Text>To assist you further in understanding this Privacy Policy, we have set out in Part 5 of Schedule 1 a glossary of terms used, examples of types of personal data we collect, how we use it, the lawful basis for processing such data and further details of your rights.</Text>
      <Text>We have appointed a data privacy manager (DPM). If you have any questions about this Privacy Policy, including any requests to exercise your legal rights, please contact our DPM in writing, using the email: info@talaikis.com</Text>
      <Text>You have the right to make a complaint at any time to the ICO (www.ico.org.uk). We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance.</Text>
      <Text>It is important that the data we hold about you is accurate and current, therefore please keep us informed of any changes to your personal data.</Text>
      <Text>Our website may include links to third-party websites, plug-ins and applications. By clicking on these links or enabling connections you may be allowing third parties to collect or share your personal data. We have no control these third-party websites, plug in or applications and are not responsible for their privacy policies, therefore you should also read their privacy policy to understand what personal data they collect about you and how they use it.</Text>

      <Title>The data we collect about you</Title>
      <Text>We may collect, use, store and transfer the types of personal data about you listed in Part 1 of Schedule 1.</Text>
      <Text>We also collect, use and share aggregated data. However, if we combine aggregated data with your personal data so that it can directly or indirectly identify you, we treat this as your personal data.</Text>
      <Text>We do not collect any special categories of personal data or any information about criminal convictions and offences.</Text>
      <Text>If we are required by law, or under the terms of a contract we have with you, to collect your personal data and you fail to provide it, we may not be able to enter into perform the contract with you and, we may have to cancel a product or service. We will notify you of this at the relevant time.</Text>

      <Title>How personal data is collected</Title>
      ...
      <Text>We will only use your personal data when the law allows us to. Most commonly, we will use your personal data:</Text>
      <ul className="list-disc pl-6">
      ...
      <Text>Part 2 of Schedule 1 sets out the lawful basis we will rely on to process your personal data.</Text>
      <Text>We do generally only rely on consent as a legal basis for processing your personal data to send email and SMS marketing communications and you have the right to withdraw your consent at any time either by contacting us or using the facilities, like unsubscribe links and profile settings, provided. Please note that we may process your personal data for more than one lawful ground depending on the specific purpose for which we are using your information.</Text>
      <Text>We may analyse your personal data to form a view on what products and or services we think may be of interest to you. You will only receive marketing communications from us, if you have requested information from us or purchased services from us, if you consent to marketing at the time we collect your personal data and you have not subsequently opted out or withdrawn your consent or if we have another basis to send you the marketing communications.</Text>
      <Text>We will get your express opt-in consent before we share your personal data with any third party for marketing purposes. We will not share your personal data with third parties for their marketing purposes.</Text>
      <Text>You can opt out of email marketing by clicking the unsubscribe link within the marketing email. You can also withdraw your consent to marketing at any time by contacting our DPM.</Text>
      <Text>Even if you opt out of receiving marketing, we may still use your personal data for other purposes provided we have a lawful basis to do so.</Text>
      <Text>We will only use your personal data for the purpose that we originally collected it for, unless we reasonably consider that we need to use it for another reason and that reason is compatible with the original purpose.</Text>
      <Text>If we need to use your personal data for an unrelated purpose, we will notify you and we will explain the legal basis which allows us to use your personal data in this manner.</Text>
      <Text>We may process your personal data (without your knowledge or consent) where this is required or permitted by law.</Text>

      <Title>Disclosure of your personal data</Title>
      <Text>We may have to share your personal data with third parties further details of which are set out in Part 4 of Schedule 1. We require all third parties to respect the security of your personal data and to treat it in accordance with the law. We do not allow our third-party service providers to use your personal data for their own purposes. They can only process your personal data for specified purposes and in accordance with our instructions.</Text>

      <Title>International transfers</Title>
      <Text>We do not transfer your personal data outside the European Economic Area (EEA).</Text>
      <Text>OR We share your personal data within the Talaikis Ltd. Group. This will involve transferring your data outside the European Economic Area (EEA).</Text>
      <Text>Whenever we transfer your personal data out of the EEA, we ensure a similar degree of protection is afforded to it by ensuring at least one of the following safeguards is implemented:</Text>
      <Text>We will only transfer your personal data to countries that have been deemed to provide an adequate level of protection for personal data by the European Commission.</Text>
      <Text>We use specific contracts approved by the European Commission which give personal data the same protection it has in Europe with our services providers;</Text>
      <Text>We may transfer data to US or other countries based service providers under the Privacy Shield which requires them to provide similar protection to personal data shared between the EU and the US.</Text>
      <Text>Please contact us if you want further information on the specific mechanism used by us when transferring your personal data.</Text>

      <Title>Data security</Title>
      <Text>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed. We also limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know and they can only process your personal data on our instructions and will be subject to a duty of confidentiality.</Text>
      <Text>We have procedures in place to deal with any suspected personal data breach and will notify you and any applicable regulator of a breach where we are legally required to do so.</Text>

      <Title>Data retention</Title>
      <Text>We will only retain your personal data for as long as necessary to fulfil the purposes we collected it for, including for the purposes of satisfying any legal, accounting, or reporting requirements.</Text>
      ...
      <Text>We may also anonymize your personal data (so that it can no longer be associated with you) for research or statistical purposes. We can use anonymized information indefinitely without further notice to you.</Text>

      <Title>Your legal rights</Title>
      <Text>You have certain rights in certain circumstances under data protection law. These are set out in full in Part 3 of Schedule 1. If you wish to exercise any of your rights, please contact our DPM.</Text>
      <Text>You will not have to pay a fee to exercise any of your rights. However, if your request is clearly unfounded, repetitive or excessive, we may charge a reasonable fee for this information or refuse to comply with your request.</Text>
      <Text>We may request specific information from you to help us confirm your identity when you contact us and ensure. This is a security measure to ensure that personal data is not disclosed to any person who does not have the right to receive it.</Text>
      <Text>We try to respond to all legitimate requests within one month. Occasionally it may take us longer than a month if your request is particularly complex or you have made a number of requests. In this case, we will notify you and keep you updated.</Text>

      <Title>Changes to this Policy</Title>
      <Text>Talaikis Ltd. reserves the right to change this Privacy Policy as we may deem necessary from time to time or as may be required by law. Any changes will be immediately posted on the Web Site and you are deemed to have accepted the terms of the Policy on your first use of the Web Site following the alterations.</Text>

      <Title>Cookies</Title>
      <Text>Talaikis Ltd. may set and access Cookies on your computer. First-party Cookies that may be placed on your computer are detailed in Schedule 2 and third-party Cookies that may be placed on your computer are detailed in Schedule 2. All Cookies used by the Web Site are used in accordance with the provisions of the Privacy and Electronic Communications (EC Directive) Regulations 2003 as amended by the Privacy and Electronic Communications (EC Directive) (Amendment) Regulations 2011.] Talaikis Ltd. has carefully chosen these Cookies and uses them to facilitate certain functions and features of the Web Site. We also use Cookies for analytics purposes. These Cookies track your activities on the Web Site and are designed to give us a better understanding of our users, thus enabling us to improve the Web Site and our services.</Text>
      <Text>Before the Web Site sets Cookies on your computer, you will be presented with a notification requesting your consent to set those Cookies. None of the Cookies set by the Web Site jeopardize your privacy in any way and no personal data is collected. By giving your consent to the setting of our Cookies you are enabling us to provide the best possible experience and service to you through our Web Site. If you wish to deny your consent to the placing of Cookies, certain features of the Web Site may not function fully or as intended.</Text>
      <Text>Certain features of the Web Site depend upon Cookies to function and are deemed, within the law, to be strictly necessary. These Cookies are detailed in Schedule 2A. You will not be asked for your consent to place these Cookies however you may still disable cookies via your web browser’s settings, as set out in sub-Clause 11.4.</Text>
      <Text>You can choose to enable or disable Cookies in your web browser. By default, your browser will accept Cookies, however this can be altered. For further details please consult the help menu in your browser. Disabling Cookies may prevent you from using the full range of Services available on the Web Site.</Text>
      <Text>You may delete Cookies at any time however you may lose any information that enables you to access the Web Site more quickly.</Text>
      <Text>The Web Site uses the third-party Cookies detailed in Schedule 3 for the purposes described therein. These Cookies are not integral to the services provided by the Web Site to you and may be blocked at your choosing via your internet browser’s privacy settings or via your response to the request for consent.</Text>
      <Text>It is recommended that you ensure that your internet browser is up-to-date and that you consult the help and guidance provided by the developer of your browser if you are unsure as to how to adjust your privacy settings.</Text>

      <Title>Schedule 1: Personal Data</Title>

      <Text><strong>Part 1: Types of personal data</strong></Text>
      <ul className="list-disc pl-6">
      ...
      <Text><strong>Part 2: Lawful basis for processing and processing activities</strong></Text>
      ...
      <ul className="list-disc pl-6">
        ...
        <li><Text>legitimate interests the processing is necessary for our or a third party’s legitimate interest e.g. in order for us to provide the best service to you via our website.</Text></li>
      </ul>
      <Text>Before we process your personal data on this basis we make sure we consider and balance any potential impact on you, and we will not use your personal data on this basis where such impact outweighs our interest.</Text>
      ...
      <ul className="list-disc pl-6">
        ...
        <li><Text>as necessary for our legitimate interests in keeping our records updated and analyzing how customers use our products/services.</Text></li>
      ...
      <Text><strong>Part 3: Your legal rights</strong></Text>
      ...
      <Text><strong>Part 4: Third Parties</strong></Text>
      <ul className="list-disc pl-6">
      ...
      <Text><strong>Part 5: Glossary</strong></Text>
      <ul className="list-disc pl-6">
      ...
      <Title>Schedule 2: First-Party Cookies</Title>
      <Text>None.</Text>

      <Title>Schedule 2A: Strictly Necessary Cookies</Title>
      <Text>None</Text>

      <Title>Schedule 3: Third-Party Cookies</Title>
      <Text>Google Analytics, for analytics purposes</Text>
    </Container>
  </Layout>
)
